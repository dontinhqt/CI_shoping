            ...
            <form method="post" action="" >
              ...
              <div class="box-body pad">
                <select name="cate" class="form-control">
                    ...
                    <?php
                        callMenu($menu,0,"--",$cate['cate_parent']);
                    ?>
                </select>
              </div>
              ...
              <div class="box box-info">
                ...
                <div class="box-body pad">
                  <input type="text" class="form-control s1" name="txttitle" value="<?php echo $cate['cate_title']; ?>" />
                </div>
                <?php echo form_error("txttitle"); ?>
              </div>

              <div class="box-footer text-center">
                <button type="submit" class="btn btn-primary" name="ok" id="ok" value="Submit">Sửa</button>
              </div>
               </form>
