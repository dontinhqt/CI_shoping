            ...
            <form method="post" action="" enctype="multipart/form-data" role="form">
              <div class="box box-info">
                ...
                <div class="box-body pad">
                  <input type="text" class="form-control s1" id="txtname" name="txtname" value="<?php echo $place['name']; ?>" />
                </div>
              </div>
              ...
              <div class="box box-info">
                ...
                <div class="box-body pad">
                  <textarea name="txtadress" ><?php echo $place['adress']; ?></textarea><br />
              ...
              <div class="box box-info">
                ...
                <div class="box-body pad">
                  <input type="text" class="form-control s1" id="txtmap" name="txtmap" <?php echo $place['map']; ?>/>
                </div>
              </div>
