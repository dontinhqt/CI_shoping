      ...
      <div class="box">
        <div class="box-body table-responsive">
          ...
          <table class="table table-hover">
            ...
            <?php
              ...
              foreach ($banner as $value) {
                ...
                echo "<td>
                        <a title='Edit' class='btn btn-xs- btn-info btn-flat' href='".base_url()."$module/banner/edit/{$value['id']}'>Sửa</a>
                      </td>";
                echo "<td>
                        <a title='Del' class='btn btn-xs- btn-danger btn-flat' href='".base_url()."$module/banner/del/{$value['id']}' onclick='return confirm_delete(\"Bạn chắc chắn muốn xóa?\")'>Xóa</a>
                      </td>";
                echo "</tr>";
              }
            ?>
          ...
          <div class="col-md-6 col-md-offset-3 text-center">
            <button class="btn btn-primary btn-block add">Thêm Banner</button> 
          </div>
          <div class="clearfix"></div>
          <hr>
          <div id="formadd">
            <form method="post" action="" enctype="multipart/form-data" role="form" id="addbanner">
